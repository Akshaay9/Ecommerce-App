...
function Filter() {
  ...
  const maxPriceofProductPresent = Math.max.apply(
    Math,
    initialGymAccessories.map(function (o) {
      return o.price;
    })
  );
  ...
  const allTheTagsOfProducts = [
    ...initialGymAccessories.map((ele) => ele.tag),
  ];
 ...
 return (
          ...
          <div className="filter-heading-sort-prices-container">
            <li>
              ...
              <input
                ...
                onClick={() =>
                  gymAccessoriesDispatch({ type: "LOW_TO_HIGH" })
                }
              />
            </li>
            <li>
              ...
              <input
                ...
                onClick={() =>
                  gymAccessoriesDispatch({ type: "HIGH_TO_LOW" })
                }
              />
            </li>
          </div>
          ...
          <div className="filter-heading-sort-rating-container">
            <li>
              ...
              <input
                ...
                onClick={() =>
                  gymAccessoriesDispatch({ type: "RATING", payload: 4 })
                }
              />
            </li>
            <li>
              ...
              <input
                ...
                onClick={() =>
                  gymAccessoriesDispatch({ type: "RATING", payload: 3 })
                }
              />
            </li>
            <li>
              ...
              <input
                ...
                onClick={() =>
                  gymAccessoriesDispatch({ type: "RATING", payload: 2 })
                }
              />
            </li>
            <li>
              ...
              <input
                ...
                onClick={() =>
                  gymAccessoriesDispatch({ type: "RATING", payload: 1 })
                }
              />
            </li>
          </div>
          ...
          <div className="filter-heading-sort-delivery-container">
            <li>
              ...
              <input
                ...
                onClick={() =>
                  gymAccessoriesDispatch({ type: "FREE_DELIVERY" })
                }
              />
            </li>
            <li>
              ...
              <input
                ...
                onClick={() =>
                  gymAccessoriesDispatch({ type: "EXPRESS_DELIVERY" })
                }
              />
            </li>
          </div>
    ...
    <GymAccessoriesProductList filterData={filterData} />
