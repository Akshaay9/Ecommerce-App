...
function Filter() {
 ...
 const {
  ...
  const maxPriceofProductPresent = Math.max.apply(
    Math,
    initialYogaProducts.map(function (o) {
      return o.price;
    })
  );
  console.log(maxPriceofProductPresent);
  ...
  const allTheTagsOfProducts = [
    ...initialYogaProducts.map((ele) => ele.tag),
  ];
 ...
 const clearFilter = () => {
   ...
   setShowFilter({
    ...
    return (
              ...
              <div className="filter-heading-sort-prices-container">
                <li>
                  ...
                  <input
                    ...
                    onClick={() =>
                      yogaProductDispatch({ type: "LOW_TO_HIGH" })
                    }
                  />
                </li>
                <li>
                  ...
                  <input
                    ...
                    onClick={() =>
                      yogaProductDispatch({ type: "HIGH_TO_LOW" })
                    }
                  />
                </li>
              </div>
              ...
              <div className="filter-heading-sort-rating-container">
                <li>
                  ...
                  <input
                    ...
                    onClick={() =>
                      yogaProductDispatch({ type: "RATING", payload: 4 })
                    }
                  />
                </li>
                <li>
                  ...
                  <input
                    ...
                    onClick={() =>
                      yogaProductDispatch({ type: "RATING", payload: 3 })
                    }
                  />
                </li>
                <li>
                  ...
                  <input
                    ...
                    onClick={() =>
                      yogaProductDispatch({ type: "RATING", payload: 2 })
                    }
                  />
                </li>
                <li>
                  ...
                  <input
                    ...
                    onClick={() =>
                      yogaProductDispatch({ type: "RATING", payload: 1 })
                    }
                  />
                </li>
              </div>
              ...
              <div className="filter-heading-sort-delivery-container">
                <li>
                  ...
                  <input
                    ...
                    onClick={() =>
                      yogaProductDispatch({ type: "FREE_DELIVERY" })
                    }
                  />
                </li>
                <li>
                  ...
                  <input
                    ...
                    onClick={() =>
                      yogaProductDispatch({ type: "EXPRESS_DELIVERY" })
                    }
                  />
                </li>
              </div>
        ...
        <YogaProductList filterData={filterData} />
