...
function Filter() {
  ...
  const maxPriceofProductPresent = Math.max.apply(
    Math,
    initialHomeWorkoutProducts.map(function (o) {
      return o.price;
    })
  );
  ...
  const allTheTagsOfProducts = [
    ...initialHomeWorkoutProducts.map((ele) => ele.tag),
  ];
  ...
  return (
    <>
            ...
            <div className="filter-heading-sort-prices-container">
              <li>
                ...
                <input
                  ...
                  onClick={() => homeWorkoutDispatch({ type: "LOW_TO_HIGH" })}
                />
              </li>
              <li>
                {" "}
                ...
                <input
                  ...
                  onClick={() => homeWorkoutDispatch({ type: "HIGH_TO_LOW" })}
                />
              </li>
            </div>
          )}
            ...
            <div className="filter-heading-sort-rating-container">
              <li>
                ...
                <input
                  ...
                  onClick={() =>
                    homeWorkoutDispatch({ type: "RATING", payload: 4 })
                  }
                />
              </li>
              <li>
                ...
                <input
                  ...
                  onClick={() =>
                    homeWorkoutDispatch({ type: "RATING", payload: 3 })
                  }
                />
              </li>
              <li>
                ...
                <input
                  ...
                  onClick={() =>
                    homeWorkoutDispatch({ type: "RATING", payload: 2 })
                  }
                />
              </li>
              <li>
                ...
                <input
                  ...
                  onClick={() =>
                    homeWorkoutDispatch({ type: "RATING", payload: 1 })
                  }
                />
              </li>
            </div>
            ...
            <div className="filter-heading-sort-delivery-container">
              <li>
                ...
                <input
                  ...
                  onClick={() => homeWorkoutDispatch({ type: "FREE_DELIVERY" })}
                />
              </li>
              <li>
                {" "}
                ...
                <input
                  ...
                  onClick={() =>
                    homeWorkoutDispatch({ type: "EXPRESS_DELIVERY" })
                  }
                />
              </li>
            </div>
      ...
      <HomeWorkoutProductList filterData={filterData} />
    </>
  );
}
